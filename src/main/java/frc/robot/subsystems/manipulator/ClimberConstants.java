...
public class ClimberConstants {
  ...
  public static final double CLIMBER_STATOR_CURRENT_LIMIT = 30;
  public static final double CLIMBER_PEAK_CURRENT_LIMIT = 40;
  public static final double CLIMBER_PEAK_CURRENT_DURATION = 2.0;
  public static final double GEAR_RATIO = 94.44444;

  public static final double CIRCUMFERENCE_OF_SPOOL = Units.inchesToMeters(1.0) * Math.PI;

  public static final double EXTENDED_POSITION_ROT = 2.0;
  public static final double RETRACTED_POSITION_ROT = 0.0;
  public static final double RETRACTING_VOLTAGE = -10.0;
  public static final double EXTENDING_VOLTAGE = 10.0;
